...
#                      default='cat:cs.CV+OR+cat:cs.LG+OR+cat:cs.CL+OR+cat:cs.NE+OR+cat:stat.ML',
                      default='cat:astro-ph+OR+cat:astro-ph.HE+OR+cat:astro-ph.SR+OR+cat:astro-ph.IM+OR+cat:astro-ph.GA+OR+cat:astro-ph.CO+OR+cat:astro-ph.EP',
                      help='query used for arxiv API. See http://arxiv.org/help/api/user-manual#detailed_examples')
  parser.add_argument('--start_index', dest='start_index', type=int, default=0, help='0 = most recent API result')
  parser.add_argument('--max_index', dest='max_index', type=int, default=300, help='upper bound on paper index we will fetch')
